...
class CoreThemes {
  ...
  static final textTheme = TextTheme(
    ...
    bodyMedium: GoogleFonts.getFont('Montserrat', fontSize: 15, fontWeight: FontWeight.w400),
    ...
    labelLarge: GoogleFonts.getFont('Roboto', fontSize: 18, fontWeight: FontWeight.w400),
  );
